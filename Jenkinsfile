	...
	{    
		...
		stage('5.Vault Installation') 
		{
			...
			{				
				...
				'''
				winRMClient credentialsId: 'llg00fbd.uk.oracle.com_kurravi_1541055948', hostName: 'llg00fbd.uk.oracle.com', winRMOperations: [invokeCommand('cd /d C:\\chef'),invokeCommand('chef-client')]				
			}
		}        
