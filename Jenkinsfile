	...
	{    
		...
		stage('5.Vault Installation') 
		{
			...
			{				
				...
				'''
				winRMClient credentialsId: 'llg00fgg.uk.oracle.com_kurravi_1541746228', hostName: 'llg00fgg.uk.oracle.com', winRMOperations: [invokeCommand('cd /d C:\\chef'),invokeCommand('chef-client')]				
			}
		}        
		stage('6.OCMS Prerequisites') 
		{
			steps 
			{
				...
				'''
				winRMClient credentialsId: 'llg00fgg.uk.oracle.com_kurravi_1541746228', hostName: 'OCMS_USERNAME', winRMOperations: [invokeCommand('cd /d C:\\chef'),invokeCommand('chef-client')]				
			}
		}
