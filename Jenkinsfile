	...
	{    
		...
		stage('5.Vault Installation') 
		{
			...
			{				
				...
				'''
				winRMClient credentialsId: 'llg00fbd.uk.oracle.com_ORADEVmonakuma_1541067891', hostName: 'OCMS_USERNAME', winRMOperations: [invokeCommand('cd /d C:\\chef'),invokeCommand('chef-client')]				
			}
		}        
