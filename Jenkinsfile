	...
	{    
		...
		stage('5.Vault Installation') 
		{
			...
			{				
				...
				'''
				winRMClient credentialsId: 'llg00fbd.uk.oracle.com_ORADEVkurravi_1541065573', hostName: 'llg00fbd.uk.oracle.com', winRMOperations: [invokeCommand('cd /d C:\\chef'),invokeCommand('chef-client')]				
			}
		}        
