	...
	{    
		...
		stage('5.Vault Installation') 
		{
			...
			{				
				...
				'''
				winRMClient credentialsId: 'llg00fgg.uk.oracle.com_kurravi_1541746851', hostName: 'llg00fgg.uk.oracle.com', winRMOperations: [invokeCommand('cd /d C:\\chef'),invokeCommand('chef-client')]				
			}
		}        
